...
impl DbContext {
    ...
    fn initialize_schema(&self) -> Result<()> {
        ...
        self.conn.execute("CREATE INDEX IF NOT EXISTS idx_parent_turn ON turns(parent_turn_id)", [])?;
        ...
        self.conn.execute("CREATE INDEX IF NOT EXISTS idx_facts_category ON facts(category)", [])?;
